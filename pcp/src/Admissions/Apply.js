...
class Apply extends Component {
  render() {
    ...
    In order to join PCP, we will hold two entrance exams at our campus in downtown Yangon. The first will be on the 25th of August (Sunday) from 9:00 AM to 12:00 PM and the second will be in October. Both entrance exams are the same, so you only need to take it once. The exam lasts all day and tests your English language, critical reading, math, and Myanmar language skills. You don’t need to do anything to prepare, except bring a pencil and a good attitude.</p>
